...
export default {
  ...
  mounted: function() {
    ...
    this.$http
      .get("https://api3-datame.herokuapp.com/api/v1/submit", {
    ...
    this.$http
      .get("https://api3-datame.herokuapp.com/api/v3/data/get_user_reviews", {
        headers: { Authorization: token }
      })
      .then(result => {
  ...
  methods: {
    ...
    createReview() {
      ...
      this.$http
        .post("https://api3-datame.herokuapp.com/api/v3/data/create_review", formData, {
          headers: { Authorization: token }
        })
        .then(result => {
    ...
    changeStatus(id) {
      ...
      this.$http
        .post("https://api3-datame.herokuapp.com/api/v1/change_status", formData, {
          headers: { Authorization: token }
        })
        .then(result => {
          this.message = result.data.message;
